...
if __name__ == "__main__":
    ...
    num_avail_ports = jetson.check() # 통신 전에 무조건 실행되야 함
    os.system(f"python multi_server.py --exp {args.exp} --num {args.num} --cli {num_avail_ports} --round {args.round} --data {args.data} --host {args.host} --port {args.port} --epochs {args.epochs} --batch {args.batch}")
